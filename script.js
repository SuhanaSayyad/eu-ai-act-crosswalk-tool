var crosswalkData = [
    {
        ...
        nist: { ref: "GOVERN 1.1", desc: "Policies, processes, procedures and practices across the organisation related to the mapping, measuring and managing of AI risks are in place, transparent and implemented effectively.", url: "https://airc.nist.gov/airmf-resources/playbook/govern/", strength: "strong" },
    ...
    },
    {
        ...
        nist: { ref: "MAP 1.5", desc: "Organisational risk tolerance is determined and communicated through policies. AI risk tolerance requirements are established and communicated to relevant AI actors.", url: "https://airc.nist.gov/airmf-resources/playbook/map/", strength: "partial" },
    ...
    },
    {
        ...
        nist: { ref: "GOVERN 1.7", desc: "Processes and procedures are in place for the timely identification of risks or incidents related to AI systems, including documentation of system design and risk assessment processes.", url: "https://airc.nist.gov/airmf-resources/playbook/govern/", strength: "partial" },
    ...
    },
    {
        ...
        nist: { ref: "GOVERN 1.7", desc: "Processes for timely identification of AI risks include logging and audit trail requirements. Record-keeping practices support accountability and traceability across the AI lifecycle.", url: "https://airc.nist.gov/airmf-resources/playbook/govern/", strength: "partial" },
    ...
    },
    {
        ...
        nist: { ref: "GOVERN 6.1", desc: "Policies and procedures are in place to address AI risks and benefits arising from third party entities. Transparency requirements for AI system capabilities and limitations are defined.", url: "https://airc.nist.gov/airmf-resources/playbook/govern/", strength: "partial" },
    ...
    },
    {
        ...
        nist: { ref: "MANAGE 4.1", desc: "Post-deployment AI risks and benefits are evaluated and responded to including processes for human review, feedback and override of AI system outputs with clear escalation paths.", url: "https://airc.nist.gov/airmf-resources/playbook/manage/", strength: "strong" },
    ...
    },
    {
        ...
        nist: { ref: "MANAGE 2.2", desc: "Mechanisms are in place to enable AI risk treatment and response including containment of AI risk incidents. Systems are designed for resilience against adversarial inputs and unintended outputs.", url: "https://airc.nist.gov/airmf-resources/playbook/manage/", strength: "strong" },
    ...
    },
    {
        ...
        nist: { ref: "GOVERN 1.4", desc: "Organisational teams are committed to following AI risk management frameworks, policies and procedures. Organisational processes align with AI risk management requirements.", url: "https://airc.nist.gov/airmf-resources/playbook/govern/", strength: "strong" },
    ...
    },
    {
        ...
        nist: { ref: "MANAGE 1.1", desc: "A determination is made as to the extent to which identified risks will be treated including assigning and tracking risk treatment activities to AI system operators and deployers.", url: "https://airc.nist.gov/airmf-resources/playbook/manage/", strength: "partial" },
    ...
    },
    {
        ...
        nist: { ref: "MAP 5.1", desc: "Likelihood and magnitude of each identified impact based on results of the completed impact assessment are mapped including potential harms to individuals, groups and society.", url: "https://airc.nist.gov/airmf-resources/playbook/map/", strength: "partial" },
    ...
    },
    {
        ...
        nist: { ref: "MEASURE 2.1", desc: "Test sets, metrics and details about evaluation tools are documented. Results of AI system testing and evaluation are used to inform risk management decisions and improvement activities.", url: "https://airc.nist.gov/airmf-resources/playbook/measure/", strength: "partial" },
    ...
    },
    {
        ...
        nist: { ref: "GOVERN 6.2", desc: "Contingency processes are in place for the organisation to respond to risks arising from interactions between AI systems and users including user-facing disclosure and communication requirements.", url: "https://airc.nist.gov/airmf-resources/playbook/govern/", strength: "partial" },
    ...
    },
    {
        ...
        nist: { ref: "GOVERN 4.1", desc: "Organisational teams are committed to a culture that considers and communicates AI risk. Training programmes for AI literacy and responsible AI practice are established and maintained.", url: "https://airc.nist.gov/airmf-resources/playbook/govern/", strength: "strong" },
    ...
    },
    {
        ...
        nist: { ref: "MAP 1.1", desc: "Context is established for AI risk assessment including defining the purpose, scope and limitations of AI use cases. Prohibited or unacceptable uses are identified and documented during system design.", url: "https://airc.nist.gov/airmf-resources/playbook/map/", strength: "indirect" },
    ...
    },
    {
        ...
        nist: { ref: "MAP 1.6", desc: "Risks or other undesirable impacts related to AI technology are examined before system deployment. Risk classification processes are established to identify high-risk AI use cases requiring enhanced controls.", url: "https://airc.nist.gov/airmf-resources/playbook/map/", strength: "partial" },
    ...
    },
    {
        ...
        nist: { ref: "MEASURE 2.11", desc: "Fairness and bias metrics are established and processes for understanding and addressing identified bias are implemented. Bias testing is conducted across demographic groups and edge cases throughout the AI lifecycle.", url: "https://airc.nist.gov/airmf-resources/playbook/measure/", strength: "strong" },
    ...
    },
    {
        ...
        nist: { ref: "MANAGE 4.2", desc: "Measurable activities for continual improvement are integrated into AI risk management processes. AI system performance and outcomes are monitored continuously to detect drift, degradation or emerging risks.", url: "https://airc.nist.gov/airmf-resources/playbook/manage/", strength: "strong" },
    ...
    },
    {
        ...
        nist: { ref: "MANAGE 3.1", desc: "Responses to AI risks deemed unacceptable are developed and planned. AI system performance and outcomes are monitored to enable identification of incidents and near-misses with appropriate escalation.", url: "https://airc.nist.gov/airmf-resources/playbook/manage/", strength: "strong" },
    ...
    },
    {
        ...
        nist: { ref: "GOVERN 1.2", desc: "Characteristics of trustworthy AI are integrated into organisational policies and procedures including documentation requirements for AI model design, training data and intended use cases.", url: "https://airc.nist.gov/airmf-resources/playbook/govern/", strength: "indirect" },
    ...
    },
    {
        ...
        nist: { ref: "GOVERN 5.1", desc: "Organisational policies and practices are in place to foster safety and reliability in AI design, development and deployment including third party risk management and supplier assessment processes.", url: "https://airc.nist.gov/airmf-resources/playbook/govern/", strength: "strong" },
    ...
    },
    {
        ...
        nist: { ref: "GOVERN 2.1", desc: "Roles and responsibilities and lines of communication related to mapping, measuring and managing AI risks are documented and are clear to individuals and teams throughout the organisation.", url: "https://airc.nist.gov/airmf-resources/playbook/govern/", strength: "strong" },
    ...
    },
    {
        ...
        nist: { ref: "MANAGE 4.2", desc: "Measurable activities for continual improvement are integrated into AI risk management processes with regular reviews of AI system performance, risk posture and effectiveness of implemented controls.", url: "https://airc.nist.gov/airmf-resources/playbook/manage/", strength: "strong" },
    ...
    },
    {
        ...
        nist: { ref: "MEASURE 1.1", desc: "Approaches and metrics for evaluating AI risks are identified and prepared. Testing environments including controlled pilots and limited deployment scenarios are established for risk measurement.", url: "https://airc.nist.gov/airmf-resources/playbook/measure/", strength: "partial" },
    ...
    },
    {
        ...
        nist: { ref: "MAP 2.1", desc: "Scientific findings and organisational practices related to AI risk are reviewed and used to inform understanding of impacts including privacy and civil rights impacts of AI system design and deployment.", url: "https://airc.nist.gov/airmf-resources/playbook/map/", strength: "partial" },
    ...
    },
    {
        ...
        nist: { ref: "GOVERN 6.1", desc: "Policies and procedures are in place to address AI risks from third party entities. Instructions for AI system use, including limitations, intended purpose and user guidance, are documented and communicated.", url: "https://airc.nist.gov/airmf-resources/playbook/govern/", strength: "partial" },
